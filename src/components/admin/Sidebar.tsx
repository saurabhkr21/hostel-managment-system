    ...
    return (
        <div className="flex h-full w-64 flex-col bg-gray-900 text-white">
            ...
            <nav className="flex-1 space-y-1 px-2 py-4">
                {navigation.map((item) => {
                    ...
                    return (
                        ...
                        >
                            <item.icon
                                className={`mr-3 h-6 w-6 shrink-0 ${isActive ? "text-white" : "text-gray-400 group-hover:text-gray-300"
                                    }`}
                                aria-hidden="true"
                            />
                            {item.name}
            ...
            <div className="border-t border-gray-800 p-4">
                ...
                >
                    <ArrowLeftOnRectangleIcon
                        className="mr-3 h-6 w-6 shrink-0 text-gray-400 group-hover:text-gray-300"
                        aria-hidden="true"
                    />
                    Sign Out
                </button>
